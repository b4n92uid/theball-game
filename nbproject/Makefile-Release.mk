...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/MinGW-Windows/theball.exe

dist/Release/MinGW-Windows/theball.exe: build/ressource.o

dist/Release/MinGW-Windows/theball.exe: /D/projets/c++/tbe/dist/Debug/MinGW-Windows/libtbe.a

dist/Release/MinGW-Windows/theball.exe: /D/Librairies/C++/Devil/DevIL-SDK-x86-1.7.8/lib/DevIL.lib

dist/Release/MinGW-Windows/theball.exe: /D/Librairies/C++/Freetype/freetype-2.3.9/objs/.libs/libfreetype.a

dist/Release/MinGW-Windows/theball.exe: /D/Librairies/C++/Sdl/SDL/SDL-1.2.14/lib/libSDLmain.a

dist/Release/MinGW-Windows/theball.exe: /D/Librairies/C++/Sdl/SDL/SDL-1.2.14/lib/libSDL.dll.a

dist/Release/MinGW-Windows/theball.exe: /D/Librairies/C++/Newton/NewtonWin-2.22/sdk/x32/dll_vs7/newton.lib

dist/Release/MinGW-Windows/theball.exe: /D/Librairies/C++/Fmod/fmodapi375win/api/lib/libfmod.a

dist/Release/MinGW-Windows/theball.exe: /D/Librairies/C++/Tinyxml/tinyxml/libtinyxml.a

dist/Release/MinGW-Windows/theball.exe: ${OBJECTFILES}
	${MKDIR} -p dist/Release/MinGW-Windows
	${LINK.cc} -mwindows -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/theball -s ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/_ext/2087136692/Player.o: /D/Projets/C++/theball/sources/Player.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2087136692
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -DTIXML_USE_STL -I/D/librairies/c++/sdl/SDL/SDL-1.2.14/include/SDL -I/D/Librairies/C++/Newton/NewtonWin-2.22/sdk -I/D/Librairies/C++/Fmod/fmodapi375win/api/inc -I/D/Librairies/C++/Tinyxml/tinyxml -I/D/projets/c++/tbe/sources -I/D/projets/c++/tbe/plugins -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2087136692/Player.o /D/Projets/C++/theball/sources/Player.cpp
...
# Subprojects
.build-subprojects:
	cd D\:/projets/c++/tbe && ${MAKE}  -f Makefile CONF=Release

# Clean Targets
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/MinGW-Windows/theball.exe

# Subprojects
.clean-subprojects:
	cd D\:/projets/c++/tbe && ${MAKE}  -f Makefile CONF=Release clean
